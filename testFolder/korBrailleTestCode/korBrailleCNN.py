...
path = 'E:/22-1/CapstoneDesign/Smart_Glass/testFolder/korBrailleTestCode/real/data.jpg'
...
def action(path):
    ...
    for i in range(0,a.lengh):
        a.devide_img()
        real = DATAGenerator.load_image('E:/22-1/CapstoneDesign/Smart_Glass/testFolder/korBrailleTestCode/testDataset/')
