...
def all_new():
    count=0
    for kor in korAlphabet:
        img = load_img('E:/22-1/CapstoneDesign/Smart_Glass/BrailleCNN/korBrailleCode/korBrailleImage/'+kor+'.jpg')  # PIL 이미지
        x = img_to_array(img)
...
def split_data():
    rootdir="E:/22-1/CapstoneDesign/Smart_Glass/BrailleCNN/korBrailleCode/ConvertData/"
