...
class img_devide():
    ...
    def create_dir(self):
        try:
            os.mkdir('E:/22-1/CapstoneDesign/Smart_Glass/BrailleCNN/EnBrailleTestCode/testDataset/a/')
            print('create new dir')
        except:
            print('already exist')
            pass
        self.path = 'E:/22-1/CapstoneDesign/Smart_Glass/BrailleCNN/EnBrailleTestCode/testDataset/a/'
